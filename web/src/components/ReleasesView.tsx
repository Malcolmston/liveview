...
// the GitHub Releases API for malcolmston/liveview.
const RELEASE_LIBS: RelLib[] = [
  { name: LIVEVIEW.name, icon: LIVEVIEW.icon, accent: LIVEVIEW.accent, repo: ghrepo(LIVEVIEW), url: LIVEVIEW.repo },
];
